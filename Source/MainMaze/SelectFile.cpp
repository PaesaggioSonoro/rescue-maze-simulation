...
void USelectFile::OpenFileDialog(const FString& DialogTitle, const FString& DefaultPath, const FString& FileTypes, TArray<FString>& OutFileNames)
{
	if (GEngine)
	{
...
void USelectFile::PrintData(const FString& File)
{
